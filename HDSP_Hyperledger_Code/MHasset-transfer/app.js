...
//// Manuka Honey ///
const pnodeController = require('./controllers/pnodeController');
const dnodeController = require('./controllers/dnodeController');
const rnodeController = require('./controllers/rnodeController');
const dbConnection = require('./db/mongooseConnection');
...
///////////////////////////////////////////////////////////////////////////////
app.use('/pnode', pnodeController); 
app.use('/dnode', dnodeController); 
app.use('/rnode', rnodeController); 

//
app.post('/add', async function (req, res) {
		logger.debug('==================== Inside End point : /add ==================');
		var peers = "peer0.pnode.example.com";
		var chaincodeName = "pcc";
		...
		var umf = req.body.umf;
		var jarWt = req.body.jarWt;
		var batch = req.body.batch;
		//var pdate = req.body.pdate;
		var pdate = '2019-10-12';
		var lab = req.body.lab;
		var floral = req.body.floral;
		var tutin = req.body.tutin;
		var pname = req.body.pname;
		var paddress = req.body.paddress;
		var pcontact = req.body.pcontact;
		var plicence = req.body.plicence;
