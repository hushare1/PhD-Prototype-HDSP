		...
		if (all_good) {
			...
			event_hubs.forEach((eh) => {
				...
				let invokeEventPromise = new Promise((resolve, reject) => {
					...
					// 			producername: args[8],
					// 			producerAdd: args[9],
					// 			producerContact: args[10],
					// 			producerLicense:  args[11],
					// 			producerCost: args[12],
					// 			distributorname:  blankData,
					// 			distributorDate: blankData,
					// 			distributorAdd:  blankData,
					// 			distributorContact:  blankData,
					// 			distributorLicense: blankData,
					// 			distributorCost: blankData,
					// 			retailername:  blankData,
					// 			retailerDate: blankData,
					// 			retailerAdd:  blankData,
					// 			retailerContact:  blankData,
					// 			retailerCost: blankData
					// 			})					
					// 		console.log(jar)
					// 		var db1 = mongoose.connection
					// 				  db1.collection('jar').insertOne(jar);	
					// 			console.log("Data inserted")
					// 			quit();
					// 	} else if (fcn == "distributorAdd") {
					// 			console.log("distributorAdd")
...
// 		console.log("Inside synchWithDB")
// 		console.log("Inside synchWithDB", args)
